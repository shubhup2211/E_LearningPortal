...
{
    /// <inheritdoc />
    public partial class elearningdb : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CourseId = table.Column<int>(type: "int", nullable: false),
                    BranchId = table.Column<int>(type: "int", nullable: true),
                    SubCourseName = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: false),
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Price = table.Column<decimal>(type: "decimal(10,2)", nullable: false),
                    Image = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
                    Status = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SubCourses_Branches_BranchId",
                        column: x => x.BranchId,
                        principalTable: "Branches",
                        principalColumn: "BranchId",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    SubscriptionCourseId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    SubscriptionId = table.Column<int>(type: "int", nullable: false),
                    CourseId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_SubscriptionCourses", x => x.SubscriptionCourseId);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SubscriptionCourses_Subscriptions_SubscriptionId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Lessons_SubCourses_SubCourseId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    UserSubCourseId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    UserId = table.Column<int>(type: "int", nullable: false),
                    SubCourseId = table.Column<int>(type: "int", nullable: false),
                    PaymentId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserSubCourses", x => x.UserSubCourseId);
                    table.ForeignKey(
                        name: "FK_UserSubCourses_Payments_PaymentId",
                        column: x => x.PaymentId,
                        principalTable: "Payments",
                        principalColumn: "PaymentId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_UserSubCourses_SubCourses_SubCourseId",
                        column: x => x.SubCourseId,
                        principalTable: "SubCourses",
                        principalColumn: "SubCourseId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_UserSubCourses_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "UserId",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<int>(type: "int", nullable: false),
                    LessonId = table.Column<int>(type: "int", nullable: false),
                    VideoCompleted = table.Column<bool>(type: "bit", nullable: true),
                    MCQCompleted = table.Column<bool>(type: "bit", nullable: true),
                    AssignmentSubmitted = table.Column<bool>(type: "bit", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MCQResults", x => x.ResultId);
                    table.ForeignKey(
                        name: "FK_MCQResults_Lessons_LessonId",
                        column: x => x.LessonId,
                        principalTable: "Lessons",
                        principalColumn: "LessonId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MCQResults_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "UserId",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AssignmentSubmissions_Users_ReviewedBy",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Lessons_SubCourseId",
                table: "Lessons",
                column: "SubCourseId");

            migrationBuilder.CreateIndex(
                name: "IX_MCQResults_LessonId",
                table: "MCQResults",
                column: "LessonId");

            migrationBuilder.CreateIndex(
                name: "IX_MCQResults_UserId",
                table: "MCQResults",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SubscriptionCourses_SubscriptionId",
                table: "SubscriptionCourses",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserSubCourses_PaymentId",
                table: "UserSubCourses",
                column: "PaymentId");

            migrationBuilder.CreateIndex(
                name: "IX_UserSubCourses_SubCourseId",
                table: "UserSubCourses",
                column: "SubCourseId");

            migrationBuilder.CreateIndex(
                name: "IX_UserSubCourses_UserId",
                table: "UserSubCourses",
                column: "UserId");
